...
if (isset($_POST['submit']) && isset($_GET['id'])) {
    ...
    $query = "UPDATE `userdetails` set  name='$name', phone='$phone', email='$email', password='$password' WHERE id='$id'";
                        ...
                        <div class="ibox-content">
                            <form action="#" method="post" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-4 control-label">Name</label>
                                    ...
                                    <div class="col-sm-8"><input type="text" name="uname" class="form-control" value="<?php if (isset($_GET['id'])){echo $data['name'];}else{echo '';}?>"></div>
                                </div>
