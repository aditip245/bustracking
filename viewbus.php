                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tr class="tablerow<?php echo $result1['id'];?>">
                                    ...
                                    <td><?php echo $result1['source']; ?></td>
                                    <td><?php echo $result1['destination']; ?></td>
                                    <td><?php echo $result1['stops']; ?></td>
                                    <td><?php echo '<a href="addbus.php?id='.$result1['id'].'"><button type="button" class="btn btn-outline btn-warning">Edit</button></a>';?>&nbsp;<?php echo '<a class="delete" id='.$result1['id'].'><button type="button" class="btn btn-outline btn-danger">Delete</button></a>';?></td>
