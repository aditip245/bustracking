                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tbody>
                                  <?php
                                        ...
                                        <td><?php echo $result1['busstop']; ?></td>
                                        <td><?php echo $result1['ckaname']; ?></td>
                                        <td><?php echo $result1['location']; ?></td>
                                        <td><?php echo $result1['pincode']; ?></td>
                                        <td><?php echo '<a href="busstop.php?id='.$result1['id'].'"><button type="button" class="btn btn-outline btn-warning">Edit</button></a>';?><?php echo '<a class="delete" id='.$result1['id'].'><button type="button" class="btn btn-outline btn-danger">Delete</button></a>';?></td>
